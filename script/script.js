...
let element = document.getElementById('container'),
    ...
    arcSetup = {
      inbound: {
        ...
        level_3: { 
          strokeColor: 'rgb(204, 51, 0)',
          strokeWidth: 0.6
        },
        level_4: { 
          strokeColor: 'rgb(204, 51, 255)',
          strokeWidth: 0.8
        },
        level_5: { 
...
const arcPopup = (data, position) => {
  ...
  popup.selectAll('.popup-content')
    .append('h3')
      .attr('class', 'title')
      .html('Source here ligne 732:' + data.origin.name);
    
  popup.selectAll('.popup-content')
    .append('h3')
      .attr('class', 'title')
      .html('Target here lign 737:' + data.destination.name);
        ...
        .style('fill', function() {
          ...
          map.svg.selectAll('.arch-container')
            .append('svg:path')
              ...
              .attr('d', d3.svg.symbol().type('triangle-down').size(0))
              .attr('stroke-width', 0)
